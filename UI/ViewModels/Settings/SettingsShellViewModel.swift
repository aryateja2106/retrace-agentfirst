...
final class SettingsShellViewModel: ObservableObject {
    ...
    private nonisolated static let searchIndex: [SettingsSearchEntry] = [
        ...
        SettingsSearchEntry(id: "exportData.comingSoon", tab: .storage, cardTitle: "Data Safety Export", cardIcon: "externaldrive.badge.checkmark",
            searchableText: ["data safety export", "portable export", "data export", "recovery manifest", "storage audit", "trash recovery", "backup", "import"]),
