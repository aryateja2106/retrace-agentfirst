...
final class SettingsShellViewModel: ObservableObject {
    ...
    private nonisolated static let searchIndex: [SettingsSearchEntry] = [
        ...
        SettingsSearchEntry(id: "context.cli", tab: .context, cardTitle: "Agent CLI", cardIcon: "terminal",
            searchableText: ["agent cli", "retrace-cli", "context", "agent context", "local context", "journal today", "ollama status"]),
        SettingsSearchEntry(id: "context.journal", tab: .context, cardTitle: "Hourly Journal", cardIcon: "book.closed",
            searchableText: ["hourly journal", "journal", "ollama", "local model", "model", "gemma", "summaries", "generate last hour", "check ollama"]),
        SettingsSearchEntry(id: "context.integrations", tab: .context, cardTitle: "Private Integrations", cardIcon: "lock.rectangle",
            searchableText: ["private integrations", "obsidian", "mcp", "models", "mlx", "local first", "privacy first"]),
        SettingsSearchEntry(id: "voice.activation", tab: .voice, cardTitle: "Voice Activation", cardIcon: "waveform",
            searchableText: ["voice activation", "voice input", "dictation", "recording", "toggle mode", "hold to talk", "push to talk", "voice shortcut", "hotkey", "shortcut placeholder"]),
        SettingsSearchEntry(id: "voice.output", tab: .voice, cardTitle: "Output", cardIcon: "doc.on.clipboard",
            searchableText: ["voice output", "clipboard", "copy transcript", "floating overlay", "overlay", "history limit", "dictation history"]),
        SettingsSearchEntry(id: "voice.customWords", tab: .voice, cardTitle: "Custom Words", cardIcon: "text.quote",
            searchableText: ["custom words", "vocabulary", "dictionary", "phrases", "names", "project terms", "raw string"]),
        SettingsSearchEntry(id: "voice.modelLifecycle", tab: .voice, cardTitle: "Model Lifecycle", cardIcon: "memorychip",
            searchableText: ["model lifecycle", "unload model", "idle", "memory", "voice model", "free memory"]),
